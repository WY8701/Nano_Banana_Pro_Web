import { GenerationTask, HistoryItem } from '../types';
import { getImageUrl } from '../services/api';

/**
 * 将后端 Task 模型映射为前端 GenerationTask 模型
 */
export const mapBackendTaskToFrontend = (task: any): GenerationTask => {
 ...
 * 将后端列表响应映射为前端列表格式
 */
export const mapBackendHistoryResponse = (response: any) => {
